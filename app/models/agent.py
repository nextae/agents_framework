...
class Agent(AgentBase, table=True):
    ...
    async def _query(self, chain_input: ChainInput) -> ChainOutput:
        """Queries the agent."""
    ...
    async def query(self, query: str, global_state: State) -> ChainOutput:
        ...
        return await self._query(chain_input)

    async def query_from_action(
        self, response: ActionQueryResponse, caller_agent: "Agent", global_state: State
    ) -> ChainOutput:
